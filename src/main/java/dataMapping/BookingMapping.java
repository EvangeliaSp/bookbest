...
public class BookingMapping {
    ...
    public BookingMapping(Statement statement) throws OWLOntologyCreationException {
    ...
    public void importData() throws OWLOntologyStorageException {
        ...
        for(Accommodation accommodation: accommodations) {
            ...
            dataToOntology.importData(this.ontologyHelper, this.owlOntology, owlIndividual, "has24HourReception", facility.getReception24Hour());
