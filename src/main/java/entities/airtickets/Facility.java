...
public class Facility {
    ...
    @Basic
    @Column(name = "nonSmokingRooms", nullable = true)
    ...
    @Basic
    @Column(name = "forDisabledGuests", nullable = true)
    ...
    @Basic
    @Column(name = "fitnessCentre", nullable = true)
    ...
    @Basic
    @Column(name = "familyRooms", nullable = true)
    ...
    @Basic
    @Column(name = "spaAndWellnessCentre", nullable = true)
    ...
    @Basic
    @Column(name = "bicycleRental", nullable = true)
    ...
    @Basic
    @Column(name = "breakfastIncluded", nullable = true)
    ...
    @Basic
    @Column(name = "breakfastAndDinner", nullable = true)
    ...
    @Basic
    @Column(name = "selfCatering", nullable = true)
    ...
    @Basic
    @Column(name = "bookWithoutCreditCard", nullable = true)
    ...
    @Basic
    @Column(name = "noPrepayment", nullable = true)
    ...
    @Basic
    @Column(name = "airConditioning", nullable = true)
    ...
    @Basic
    @Column(name = "coffeeMachine", nullable = true)
    ...
    @Basic
    @Column(name = "electricKettle", nullable = true)
    ...
    @Basic
    @Column(name = "flatScreenTV", nullable = true)
    ...
    @Basic
    @Column(name = "kitchenKitchenette", nullable = true)
    ...
    @Basic
    @Column(name = "soundProofing", nullable = true)
    ...
    @Basic
    @Column(name = "teaCoffeeMaker", nullable = true)
